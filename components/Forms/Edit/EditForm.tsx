...
function EditForm({
  ...
  return (
    <>
      <div
        className={`-z-10 absolute top-0 left-0 w-screen h-screen bg-slate-600 dark:bg-white/60 ${
          open ? "block" : "hidden"
        } `}
      >
        <div id="Container">
          <form
            className="form w-[170px] sm:w-auto"
            onSubmit={formik.handleSubmit}
          >
            <div id="login-lable" className="sm:text-xl">
              Update Todo
            </div>
            <input
            ...
            <Button className="sm:text-xl btn">Update Todo</Button>
          </form>
          ...
          <div id="emiter">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stop-color="#000"></stop>
                  <stop stop-color="#000" offset="0.901042"></stop>
                </radialGradient>
              </defs>
            </svg>
          </div>
